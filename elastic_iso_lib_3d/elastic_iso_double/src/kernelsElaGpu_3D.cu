...
__global__ void stepFwdGpu_3D(double *dev_o_vx, double *dev_o_vy, double *dev_o_vz, double *dev_o_sigmaxx, double *dev_o_sigmayy, double *dev_o_sigmazz, double *dev_o_sigmaxz, double *dev_o_sigmaxy, double *dev_o_sigmayz, double *dev_c_vx, double *dev_c_vy, double *dev_c_vz, double *dev_c_sigmaxx, double *dev_c_sigmayy, double *dev_c_sigmazz, double *dev_c_sigmaxz, double *dev_c_sigmaxy, double *dev_c_sigmayz, double *dev_n_vx, double *dev_n_vy, double *dev_n_vz, double *dev_n_sigmaxx, double *dev_n_sigmayy, double *dev_n_sigmazz, double *dev_n_sigmaxz, double *dev_n_sigmaxy, double *dev_n_sigmayz, double* dev_rhoxDtw, double* dev_rhoyDtw, double* dev_rhozDtw, double* dev_lamb2MuDtw, double* dev_lambDtw, double* dev_muxzDtw, double* dev_muxyDtw, double* dev_muyzDtw, int nx, int ny, int nz){
	...
	shared_c_sigmayz[ixLocal][izLocal] = dev_c_sigmayz[iGlobalTemp+=yStride]; // Only the central point on the y-axis is stored in the shared memory // iy = 2
	...
	for (long long iy=FAT; iy<ny-FAT; iy++){
		...
		dev_c_vx_y[6] = dev_c_vx[iGlobalTemp+yStride];
		...
		dev_c_vy_y[6] = dev_c_vy[iGlobalTemp+yStride];
		...
		dev_c_vz_y[6] = dev_c_vz[iGlobalTemp+yStride];
		...
		dev_c_sigmaxy_y[6] = dev_c_sigmaxy[iGlobalTemp+yStride];
		...
		dev_c_sigmayy_y[6] = dev_c_sigmayy[iGlobalTemp+yStride];
		...
		dev_c_sigmayz_y[6] = dev_c_sigmayz[iGlobalTemp+=yStride]; // The last point of the stencil now points to the next y-slice
...
__global__ void stepFwdGpu_3DTEST(double *dev_o_vx, double *dev_o_vy, double *dev_o_vz, double *dev_o_sigmaxx, double *dev_o_sigmayy, double *dev_o_sigmazz, double *dev_o_sigmaxz, double *dev_o_sigmaxy, double *dev_o_sigmayz, double *dev_c_vx, double *dev_c_vy, double *dev_c_vz, double *dev_c_sigmaxx, double *dev_c_sigmayy, double *dev_c_sigmazz, double *dev_c_sigmaxz, double *dev_c_sigmaxy, double *dev_c_sigmayz, double *dev_n_vx, double *dev_n_vy, double *dev_n_vz, double *dev_n_sigmaxx, double *dev_n_sigmayy, double *dev_n_sigmazz, double *dev_n_sigmaxz, double *dev_n_sigmaxy, double *dev_n_sigmayz, double* dev_rhoxDtw, double* dev_rhoyDtw, double* dev_rhozDtw, double* dev_lamb2MuDtw, double* dev_lambDtw, double* dev_muxzDtw, double* dev_muxyDtw, double* dev_muyzDtw, int nx, int ny, int nz){
	...
	for (long long iy=FAT; iy<ny-FAT; iy++){
		...
		// double Coeff0 = 1.196289062541883 / 10.;
		// double Coeff1 = -0.079752604188901 / 10.;
		// double Coeff2 = 0.009570312506634 / 10.;
		// double Coeff3 = -6.975446437140719e-04 / 10.;
...
__global__ void stepFwdGpu_3DGlobal(double *dev_o_vx, double *dev_o_vy, double *dev_o_vz, double *dev_o_sigmaxx, double *dev_o_sigmayy, double *dev_o_sigmazz, double *dev_o_sigmaxz, double *dev_o_sigmaxy, double *dev_o_sigmayz, double *dev_c_vx, double *dev_c_vy, double *dev_c_vz, double *dev_c_sigmaxx, double *dev_c_sigmayy, double *dev_c_sigmazz, double *dev_c_sigmaxz, double *dev_c_sigmaxy, double *dev_c_sigmayz, double *dev_n_vx, double *dev_n_vy, double *dev_n_vz, double *dev_n_sigmaxx, double *dev_n_sigmayy, double *dev_n_sigmazz, double *dev_n_sigmaxz, double *dev_n_sigmaxy, double *dev_n_sigmayz, double* dev_rhoxDtw, double* dev_rhoyDtw, double* dev_rhozDtw, double* dev_lamb2MuDtw, double* dev_lambDtw, double* dev_muxzDtw, double* dev_muxyDtw, double* dev_muyzDtw, int nx, int ny, int nz){
    ...
    // 								dev_yCoeff[3]*(dev_c_vy_y[6]-dev_c_vy_y[0]);
		...
		double dvy_dy = dev_yCoeff[0]*(dev_c_vy[iGlobal+yStride]-dev_c_vy_y[3]) +
    								dev_yCoeff[1]*(dev_c_vy[iGlobal+2*yStride]-dev_c_vy[iGlobal-yStride])+
    								dev_yCoeff[2]*(dev_c_vy[iGlobal+3*yStride]-dev_c_vy[iGlobal-2*yStride])+
    								dev_yCoeff[3]*(dev_c_vy[iGlobal+4*yStride]-dev_c_vy[iGlobal-3*yStride]);
		...
		dev_n_vy[iGlobal] = dev_o_vy[iGlobal] + dev_rhoyDtw[iGlobal] * (
										      ...
										      dev_xCoeff[3]*(shared_c_sigmaxy[ixLocal+4][izLocal]-shared_c_sigmaxy[ixLocal-3][izLocal]) +
											    ...
											    // dev_yCoeff[2]*(dev_c_sigmayy_y[5]-dev_c_sigmayy_y[1])+
											    // dev_yCoeff[3]*(dev_c_sigmayy_y[6]-dev_c_sigmayy_y[0])+
													dev_yCoeff[0]*(dev_c_sigmayy[iGlobal]-dev_c_sigmayy[iGlobal-yStride]) +
			    								dev_yCoeff[1]*(dev_c_sigmayy[iGlobal+yStride]-dev_c_sigmayy[iGlobal-2*yStride])+
			    								dev_yCoeff[2]*(dev_c_sigmayy[iGlobal+2*yStride]-dev_c_sigmayy[iGlobal-3*yStride])+
			    								dev_yCoeff[3]*(dev_c_sigmayy[iGlobal+3*yStride]-dev_c_sigmayy[iGlobal-4*yStride])+
													// dsigmayz/dz (+)
													dev_zCoeff[0]*(shared_c_sigmayz[ixLocal][izLocal+1]-shared_c_sigmayz[ixLocal][izLocal])  +
										      dev_zCoeff[1]*(shared_c_sigmayz[ixLocal][izLocal+2]-shared_c_sigmayz[ixLocal][izLocal-1])+
										      dev_zCoeff[2]*(shared_c_sigmayz[ixLocal][izLocal+3]-shared_c_sigmayz[ixLocal][izLocal-2])+
