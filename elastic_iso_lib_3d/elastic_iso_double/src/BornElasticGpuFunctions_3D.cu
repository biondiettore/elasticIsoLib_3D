...
void copyHalosSSLeft(long long offset_rec, long long offset_snd, int iGpu, int jGpu, int dstDevice, int srcDevice, long long yStride, cudaStream_t stream){
	...
	// Vx
	cuda_call(cudaMemcpyPeerAsync(dev_ssVxLeft[iGpu]+offset_rec, dstDevice, dev_ssVxLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Vy
	cuda_call(cudaMemcpyPeerAsync(dev_ssVyLeft[iGpu]+offset_rec, dstDevice, dev_ssVyLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Vz
	cuda_call(cudaMemcpyPeerAsync(dev_ssVzLeft[iGpu]+offset_rec, dstDevice, dev_ssVzLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmaxx
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmaxxLeft[iGpu]+offset_rec, dstDevice, dev_ssSigmaxxLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmayy
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmayyLeft[iGpu]+offset_rec, dstDevice, dev_ssSigmayyLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmazz
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmazzLeft[iGpu]+offset_rec, dstDevice, dev_ssSigmazzLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmaxz
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmaxzLeft[iGpu]+offset_rec, dstDevice, dev_ssSigmaxzLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmaxy
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmaxyLeft[iGpu]+offset_rec, dstDevice, dev_ssSigmaxyLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmayz
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmayzLeft[iGpu]+offset_rec, dstDevice, dev_ssSigmayzLeft[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
...
void copyHalosSSRight(long long offset_rec, long long offset_snd, int iGpu, int jGpu, int dstDevice, int srcDevice, long long yStride, cudaStream_t stream){
	...
	// Vx
	cuda_call(cudaMemcpyPeerAsync(dev_ssVxRight[iGpu]+offset_rec, dstDevice, dev_ssVxRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Vy
	cuda_call(cudaMemcpyPeerAsync(dev_ssVyRight[iGpu]+offset_rec, dstDevice, dev_ssVyRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Vz
	cuda_call(cudaMemcpyPeerAsync(dev_ssVzRight[iGpu]+offset_rec, dstDevice, dev_ssVzRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmaxx
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmaxxRight[iGpu]+offset_rec, dstDevice, dev_ssSigmaxxRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmayy
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmayyRight[iGpu]+offset_rec, dstDevice, dev_ssSigmayyRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmazz
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmazzRight[iGpu]+offset_rec, dstDevice, dev_ssSigmazzRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmaxz
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmaxzRight[iGpu]+offset_rec, dstDevice, dev_ssSigmaxzRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmaxy
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmaxyRight[iGpu]+offset_rec, dstDevice, dev_ssSigmaxyRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
	// Sigmayz
	cuda_call(cudaMemcpyPeerAsync(dev_ssSigmayzRight[iGpu]+offset_rec, dstDevice, dev_ssSigmayzRight[jGpu]+offset_snd, srcDevice, yStride*FAT*sizeof(double), stream));
...
void BornElasticFwdGpudomDec_3D(double *sourceRegDts_vx, double *sourceRegDts_vy, double *sourceRegDts_vz, double *sourceRegDts_sigmaxx, double *sourceRegDts_sigmayy, double *sourceRegDts_sigmazz, double *sourceRegDts_sigmaxz, double *sourceRegDts_sigmaxy, double *sourceRegDts_sigmayz, double *dataRegDts_vx, double *dataRegDts_vy, double *dataRegDts_vz, double *dataRegDts_sigmaxx, double *dataRegDts_sigmayy, double *dataRegDts_sigmazz, double *dataRegDts_sigmaxz, double *dataRegDts_sigmaxy, double *dataRegDts_sigmayz, long long *sourcesPositionRegCenterGrid, long long nSourcesRegCenterGrid, long long *sourcesPositionRegXGrid, long long nSourcesRegXGrid, long long *sourcesPositionRegYGrid, long long nSourcesRegYGrid, long long *sourcesPositionRegZGrid, long long nSourcesRegZGrid, long long *sourcesPositionRegXZGrid, long long nSourcesRegXZGrid, long long *sourcesPositionRegXYGrid, long long nSourcesRegXYGrid, long long *sourcesPositionRegYZGrid, long long nSourcesRegYZGrid, long long *receiversPositionRegCenterGrid, long long nReceiversRegCenterGrid, long long *receiversPositionRegXGrid, long long nReceiversRegXGrid, long long *receiversPositionRegYGrid, long long nReceiversRegYGrid, long long *receiversPositionRegZGrid, long long nReceiversRegZGrid, long long *receiversPositionRegXZGrid, long long nReceiversRegXZGrid, long long *receiversPositionRegXYGrid, long long nReceiversRegXYGrid, long long *receiversPositionRegYZGrid, long long nReceiversRegYZGrid, double *drhox, double *drhoy, double *drhoz, double *dlame,  double *dmu, double *dmuxz, double *dmuxy, double *dmuyz, int nx, int ny, int nz, std::vector<int> ny_domDec, std::vector<int> gpuList){
  ...
  cudaStream_t haloStream[nGpu], bodyStream[nGpu], transferStream[nGpu];
	...
	for(int iGpu=0; iGpu<nGpu; iGpu++){
		cuda_call(cudaSetDevice(gpuList[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVx_left[iGpu], host_pinned_wavefield_vx[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVy_left[iGpu], host_pinned_wavefield_vy[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVz_left[iGpu], host_pinned_wavefield_vz[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
	}

	// Copy wavefield time-slice its = 1: pinned -> dev_pSourceWavefield_cur
	for(int iGpu=0; iGpu<nGpu; iGpu++){
		cuda_call(cudaSetDevice(gpuList[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVx_cur[iGpu], host_pinned_wavefield_vx[iGpu]+nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVy_cur[iGpu], host_pinned_wavefield_vy[iGpu]+nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVz_cur[iGpu], host_pinned_wavefield_vz[iGpu]+nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaStreamSynchronize(transferStream[iGpu]));
	}
	...
	for(int iGpu=0; iGpu<nGpu; iGpu++){
		cuda_call(cudaSetDevice(gpuList[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_pStream_Vx[iGpu], host_pinned_wavefield_vx[iGpu]+2*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_pStream_Vy[iGpu], host_pinned_wavefield_vy[iGpu]+2*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_pStream_Vz[iGpu], host_pinned_wavefield_vz[iGpu]+2*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaStreamSynchronize(transferStream[iGpu]));
	}
	...
	for (int its = 0; its < host_nts-1; its++){
		if (its < host_nts-2){
			for(int iGpu=0; iGpu<nGpu; iGpu++){
				cuda_call(cudaSetDevice(gpuList[iGpu]));
				// Copy wavefield value at its+1 from pStream -> pSourceWavefield
				cuda_call(cudaMemcpyAsync(dev_wavefieldVx_right[iGpu], dev_pStream_Vx[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToDevice, bodyStream[iGpu]));
				cuda_call(cudaMemcpyAsync(dev_wavefieldVy_right[iGpu], dev_pStream_Vy[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToDevice, bodyStream[iGpu]));
				cuda_call(cudaMemcpyAsync(dev_wavefieldVz_right[iGpu], dev_pStream_Vz[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToDevice, bodyStream[iGpu]));
			}
		}
		...
		if (its < host_nts-3){
			for(int iGpu=0; iGpu<nGpu; iGpu++){
				...
				// Copy wavefield slice its+2 from pinned > dev_pStream
				cuda_call(cudaStreamSynchronize(bodyStream[iGpu]));
				cuda_call(cudaMemcpyAsync(dev_pStream_Vx[iGpu], host_pinned_wavefield_vx[iGpu]+(its+3)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
				cuda_call(cudaMemcpyAsync(dev_pStream_Vy[iGpu], host_pinned_wavefield_vy[iGpu]+(its+3)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
				cuda_call(cudaMemcpyAsync(dev_pStream_Vz[iGpu], host_pinned_wavefield_vz[iGpu]+(its+3)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
			}
		}
		...
		for(int iGpu=0; iGpu<nGpu; iGpu++){
			cuda_call(cudaSetDevice(gpuList[iGpu]));
			switchPointersSecondarySource_3D(iGpu);
			cuda_call(cudaMemsetAsync(dev_ssVxRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssVyRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssVzRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssSigmaxxRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssSigmayyRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssSigmazzRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssSigmaxzRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssSigmaxyRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			cuda_call(cudaMemsetAsync(dev_ssSigmayzRight[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
		}
...
void BornElasticAdjGpudomDec_3D(double *sourceRegDts_vx, double *sourceRegDts_vy, double *sourceRegDts_vz, double *sourceRegDts_sigmaxx, double *sourceRegDts_sigmayy, double *sourceRegDts_sigmazz, double *sourceRegDts_sigmaxz, double *sourceRegDts_sigmaxy, double *sourceRegDts_sigmayz, double *dataRegDts_vx, double *dataRegDts_vy, double *dataRegDts_vz, double *dataRegDts_sigmaxx, double *dataRegDts_sigmayy, double *dataRegDts_sigmazz, double *dataRegDts_sigmaxz, double *dataRegDts_sigmaxy, double *dataRegDts_sigmayz, long long *sourcesPositionRegCenterGrid, long long nSourcesRegCenterGrid, long long *sourcesPositionRegXGrid, long long nSourcesRegXGrid, long long *sourcesPositionRegYGrid, long long nSourcesRegYGrid, long long *sourcesPositionRegZGrid, long long nSourcesRegZGrid, long long *sourcesPositionRegXZGrid, long long nSourcesRegXZGrid, long long *sourcesPositionRegXYGrid, long long nSourcesRegXYGrid, long long *sourcesPositionRegYZGrid, long long nSourcesRegYZGrid, long long *receiversPositionRegCenterGrid, long long nReceiversRegCenterGrid, long long *receiversPositionRegXGrid, long long nReceiversRegXGrid, long long *receiversPositionRegYGrid, long long nReceiversRegYGrid, long long *receiversPositionRegZGrid, long long nReceiversRegZGrid, long long *receiversPositionRegXZGrid, long long nReceiversRegXZGrid, long long *receiversPositionRegXYGrid, long long nReceiversRegXYGrid, long long *receiversPositionRegYZGrid, long long nReceiversRegYZGrid, double *drhox, double *drhoy, double *drhoz, double *dlame,  double *dmu, double *dmuxz, double *dmuxy, double *dmuyz, int nx, int ny, int nz, std::vector<int> ny_domDec, std::vector<int> gpuList){
  ...
  cudaStream_t haloStream[nGpu], bodyStream[nGpu], transferStream[nGpu];
	...
	for(int iGpu=0; iGpu<nGpu; iGpu++){
		cuda_call(cudaSetDevice(gpuList[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVx_right[iGpu], host_pinned_wavefield_vx[iGpu]+(host_nts-1)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVy_right[iGpu], host_pinned_wavefield_vy[iGpu]+(host_nts-1)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVz_right[iGpu], host_pinned_wavefield_vz[iGpu]+(host_nts-1)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));

		// Copy wavefield time-slice its = 1: pinned -> dev_pSourceWavefield_cur
		cuda_call(cudaMemcpyAsync(dev_wavefieldVx_cur[iGpu], host_pinned_wavefield_vx[iGpu]+(host_nts-2)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVy_cur[iGpu], host_pinned_wavefield_vy[iGpu]+(host_nts-2)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
		cuda_call(cudaMemcpyAsync(dev_wavefieldVz_cur[iGpu], host_pinned_wavefield_vz[iGpu]+(host_nts-2)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
	}
	...
	for (int its = host_nts-2; its > -1; its--){
			...
			if(its > 0){
				...
				for(int iGpu=0; iGpu<nGpu; iGpu++){
					cuda_call(cudaSetDevice(gpuList[iGpu]));
					cuda_call(cudaStreamSynchronize(bodyStream[iGpu]));
					cuda_call(cudaMemcpyAsync(dev_pStream_Vx[iGpu], host_pinned_wavefield_vx[iGpu]+(its-1)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
					cuda_call(cudaMemcpyAsync(dev_pStream_Vy[iGpu], host_pinned_wavefield_vy[iGpu]+(its-1)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
					cuda_call(cudaMemcpyAsync(dev_pStream_Vz[iGpu], host_pinned_wavefield_vz[iGpu]+(its-1)*nModel[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyHostToDevice, transferStream[iGpu]));
				}
			}
			...
			if(its > 0){
				for(int iGpu=0; iGpu<nGpu; iGpu++){
					cuda_call(cudaSetDevice(gpuList[iGpu]));
					cuda_call(cudaMemcpyAsync(dev_wavefieldVx_left[iGpu], dev_pStream_Vx[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToDevice, bodyStream[iGpu]));
					cuda_call(cudaMemcpyAsync(dev_wavefieldVy_left[iGpu], dev_pStream_Vy[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToDevice, bodyStream[iGpu]));
					cuda_call(cudaMemcpyAsync(dev_wavefieldVz_left[iGpu], dev_pStream_Vz[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToDevice, bodyStream[iGpu]));
				}
			}
			...
			for(int iGpu=0; iGpu<nGpu; iGpu++){
				cuda_call(cudaSetDevice(gpuList[iGpu]));
				switchPointersSecondarySource_3D(iGpu);
				cuda_call(cudaMemsetAsync(dev_ssVxLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssVyLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssVzLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssSigmaxxLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssSigmayyLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssSigmazzLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssSigmaxzLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssSigmaxyLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
				cuda_call(cudaMemsetAsync(dev_ssSigmayzLeft[iGpu], 0, nModel[iGpu]*sizeof(double), bodyStream[iGpu]));
			}
	...
	for(int iGpu=0; iGpu<nGpu; iGpu++){
		...
		cuda_call(cudaMemcpy(model_drhozTmp+shift, dev_drhoz[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToHost));
		cuda_call(cudaMemcpy(model_dlameTmp+shift, dev_dlame[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToHost));
		cuda_call(cudaMemcpy(model_dmuTmp+shift, dev_dmu[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToHost));
		cuda_call(cudaMemcpy(model_dmuxzTmp+shift, dev_dmuxz[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToHost));
		cuda_call(cudaMemcpy(model_dmuxyTmp+shift, dev_dmuxy[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToHost));
		cuda_call(cudaMemcpy(model_dmuyzTmp+shift, dev_dmuyz[iGpu], nModel[iGpu]*sizeof(double), cudaMemcpyDeviceToHost));
