...
*/
class staggerZ : public Operator<SEP::double3DReg, SEP::double3DReg> {
    ...
    */
		staggerZ(const std::shared_ptr<double3DReg> model, const std::shared_ptr<double3DReg> data);
...
/*!
 Used for creating the staggered grid elastic parameters used for leastic wave prop
*/
class staggerX : public Operator<double3DReg, double3DReg> {
    ...
    * Overloaded constructors from operator
    */
		staggerX(const std::shared_ptr<double3DReg> model, const std::shared_ptr<double3DReg> data);
...
/*!
 Used for creating the staggered grid elastic parameters used for leastic wave prop
*/
class staggerY : public Operator<SEP::double3DReg, SEP::double3DReg> {
    ...
    * Overloaded constructors from operator
    */
		staggerY(const std::shared_ptr<double3DReg> model, const std::shared_ptr<double3DReg> data);
