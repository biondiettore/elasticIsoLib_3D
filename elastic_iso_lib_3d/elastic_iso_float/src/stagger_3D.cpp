...
/******************************************************************************/
staggerZ::staggerZ(const std::shared_ptr<float3DReg> model, const std::shared_ptr<float3DReg> data){
...
void staggerZ::forward(const bool add,const  std::shared_ptr<float3DReg> model,  std::shared_ptr<float3DReg> data) const {
...
void staggerZ::adjoint(const bool add, std::shared_ptr<float3DReg> model, const std::shared_ptr<float3DReg> data) const{
  if( not checkDomainRange(model,data)){
...
/******************************************************************************/
staggerX::staggerX(const std::shared_ptr<float3DReg> model, const std::shared_ptr<float3DReg> data){
  if( not data->getHyper()->getAxis(1).n == model->getHyper()->getAxis(1).n){
...
void staggerX::forward(const bool add,const  std::shared_ptr<float3DReg> model,  std::shared_ptr<float3DReg> data) const{
  if( not checkDomainRange(model,data)){
...
void staggerX::adjoint(const bool add,const  std::shared_ptr<float3DReg> model,  std::shared_ptr<float3DReg> data) const{
	if( not checkDomainRange(model,data)){
...
/******************************************************************************/
staggerY::staggerY(const std::shared_ptr<float3DReg> model, const std::shared_ptr<float3DReg> data){
  if( not data->getHyper()->getAxis(1).n == model->getHyper()->getAxis(1).n){
...
void staggerY::forward(const bool add,const  std::shared_ptr<float3DReg> model,  std::shared_ptr<float3DReg> data) const{
  if( not checkDomainRange(model,data)){
...
void staggerY::adjoint(const bool add,const  std::shared_ptr<float3DReg> model,  std::shared_ptr<float3DReg> data) const{
	if( not checkDomainRange(model,data)){
