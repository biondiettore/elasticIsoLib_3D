...
fdParamElastic_3D::fdParamElastic_3D(const std::shared_ptr<float4DReg> elasticParam, const std::shared_ptr<paramObj> par) {
	...
	for (int iy = _fat; iy < _ny-2*_fat; iy++){
		for (int ix = _fat; ix < _nx-2*_fat; ix++){
			for (int iz = _fat; iz < _nz-2*_fat; iz++){
				float rhoTemp = (*_elasticParam->_mat)[0][iy][ix][iz];
				float lamdbTemp = (*_elasticParam->_mat)[1][iy][ix][iz];
				float muTemp = (*_elasticParam->_mat)[2][iy][ix][iz];
	...
	_rhoxDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_rhoyDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_rhozDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_lambDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_lamb2MuDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_muxzDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_muxyDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	_muyzDtwReg = std::make_shared<float3DReg>(_elasticParam->getHyper()->getAxis(1), _elasticParam->getHyper()->getAxis(2), _elasticParam->getHyper()->getAxis(3));
	...
	std::memcpy(_lambDtwReg->getVals(), _elasticParam->getVals(), _nModel*sizeof(float));
	std::memcpy(_lamb2MuDtwReg->getVals(), _elasticParam->getVals()+2*_nModel, _nModel*sizeof(float));
...
bool fdParamElastic_3D::checkFdStability_3D(float CourantMax){
...
bool fdParamElastic_3D::checkFdDispersion_3D(float dispersionRatioMin){
...
bool fdParamElastic_3D::checkParfileConsistencyTime_3D(const std::shared_ptr<float3DReg> seismicTraces, int timeAxisIndex, std::string fileToCheck) const {
...
bool fdParamElastic_3D::checkParfileConsistencySpace_3D(const std::shared_ptr<float4DReg> model, std::string fileToCheck) const {
